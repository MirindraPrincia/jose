...
const contactInfo = [
    ...
    { type: 'email', label: encode('joserandrianaivo28@gmail.com'), href: encode('mailto:joserandrianaivo28@gmail.com') },
];
...
const socials = [
    ...
    { id: 'email', label: 'Email', href: encode('mailto:joserandrianaivo28@gmail.com') },
